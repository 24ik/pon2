...
import std/[options, sequtils, tables, uri]
import ./[nazoPuyo]
...
func accept[
    ...
    M: MoveResult or RoughMoveResult or DetailMoveResult or FullMoveResult](
      req: Requirement, moveResult: M, field: F,

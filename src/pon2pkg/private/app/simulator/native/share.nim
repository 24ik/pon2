...
proc initShareControl*(simulator: ref Simulator): ShareControl {.inline.} =
  ...
  shareButtonWithoutUrl.onClick =
    (event: ClickEvent) =>
    ($simulator[].toXLink(withPositions = false)).openDefaultBrowser
  ...
  shareButtonWithUrl.onClick =
    (event: ClickEvent) =>
    ($simulator[].toXLink(withPositions = true)).openDefaultBrowser
  ...
  copyButtonWithoutUrl.onClick =
    (event: ClickEvent) =>
    (app.clipboardText = $simulator[].toUri(withPositions = false))
  ...
  copyButtonWithUrl.onClick =
    (event: ClickEvent) => (
      app.clipboardText = $simulator[].toUri(withPositions = true)
    )
